...
electricity market bidding zones from Tomorrow's electricityMap
...
# import data
if path.isfile('../data/bidding_zones.geojson'):
    zones = gpd.read_file('../data/bidding_zones.geojson')
elif path.isfile('data/bidding_zones.geojson'):
    zones = gpd.read_file('data/bidding_zones.geojson')
else:
