...
url = 'https://ec.europa.eu/eurostat/cache/GISCO/distribution/v2/nuts/geojson/NUTS_RG_01M_2016_4326_LEVL_0.geojson'
...
# save as GeoJSON
nuts0.to_file('data/nuts0.geojson', driver='GeoJSON')
"""
